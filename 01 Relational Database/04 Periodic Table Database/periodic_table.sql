...
--
-- Name: properties fk_prop_elem; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_prop_elem FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
